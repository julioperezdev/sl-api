...
public class ExecuteBuyOperationService implements ExecuteBuyOperation {
    ...
    public ExecuteBuyOperationService(ExecuteBuyOperationOutputPort executeBuyOperationOutputPort, GetOperations getOperations, UpdateCurrencyMultiBox updateCurrencyMultiBox, PrintOperation printOperation) {
