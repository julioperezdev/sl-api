...
public interface RecordOfficeBoxToConfirmEgress {
    CurrencyMultiBox execute(CurrencyMultiBox officeBox, BuyOperation buyOperation, LastQuantityAndQuantityViewed actualQuantityAndQuantityViewedByPesosOrOfficeBox);
}
