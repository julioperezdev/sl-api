...
public interface RecordPesosBoxToConfirmEgress {
    CurrencyMultiBox execute(CurrencyMultiBox pesosBox, BuyOperation buyOperation, LastQuantityAndQuantityViewed actualQuantityAndQuantityViewedByPesosOrOfficeBox);
}
