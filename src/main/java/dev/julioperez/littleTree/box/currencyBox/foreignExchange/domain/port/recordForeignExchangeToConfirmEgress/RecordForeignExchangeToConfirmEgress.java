...
public interface RecordForeignExchangeToConfirmEgress {
    CurrencyMultiBox execute(CurrencyMultiBox foreignExchangeBox, SellOperation sellOperation, LastQuantityAndQuantityViewed actualQuantityAndQuantityViewedByForeignExchangeBox);
}
