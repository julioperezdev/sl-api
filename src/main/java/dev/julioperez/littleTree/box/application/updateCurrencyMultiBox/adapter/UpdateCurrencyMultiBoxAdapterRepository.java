package dev.julioperez.littleTree.box.application.updateCurrencyMultiBox.adapter;
...
import dev.julioperez.littleTree.box.domain.port.updateCurrencyMultiBox.UpdateCurrencyMultiBoxOutputPort;
